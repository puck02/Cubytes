...
> **Windows 用户注意**：便携版安装后，使用手动编译方式学习（无 `cling watch` 命令）。  
> 编译命令：`.\mingw64\bin\gcc.exe exercises\练习名.c -o 输出.exe`
...
cd Cling
# 手动编译练习
.\mingw64\bin\gcc.exe exercises\00_intro\intro1.c -o intro1.exe
.\intro1.exe
```
